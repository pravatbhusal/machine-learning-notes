...
"resource": {
  ...
  "tags":[{
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript\u003Ewindow._fbq=window._fbq||[];\n_fbq.push([\"track\",\"Purchase\",{content_ids:",["escape",["macro",38],8,16],",content_type:\"product\",order_id:",["escape",["macro",39],8,16],",value:",["escape",["macro",2],8,16],",currency:\"USD\",course_avg_rating:",["escape",["macro",26],8,16],",course_category:",["escape",["macro",27],8,16],",course_instructor_name:",["escape",["macro",28],8,16],",course_language:",["escape",["macro",23],8,16],",course_length_minutes:",["escape",["macro",29],8,16],",course_locale:",["escape",["macro",30],8,16],",course_num_enrollments:",["escape",["macro",31],8,16],",course_subcategory:",["escape",["macro",32],8,16],",course_topic:",["escape",["macro",33],8,16],",\nuser_language:",["escape",["macro",22],8,16],",user_locale:",["escape",["macro",34],8,16],",user_location:",["escape",["macro",35],8,16],",has_made_paid_purchase:",["escape",["macro",36],8,16],",is_first_paid_purchase:",["escape",["macro",40],8,16],"}]);\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
  ...
  "rules":[
    [["if",0,3],["unless",1,2],["add",1,42]],
    [["if",5,6],["add",2,9,10,13,15,16,20,23,33,38,40,52,53,60,61]],
    [["if",3,7],["add",3,4]],
    [["if",3,4],["add",5],["block",1,7,34,0,39,46,49,54,58]],
    [["if",3],["add",5,39,54,57,25,26,28,29,30]],
    [["if",3,9],["unless",8],["add",6,14,42]],
    [["if",10,11],["add",7]],
    [["if",12,13,14],["add",8]],
    [["if",3,15],["add",11,44]],
    [["if",14,16,17],["add",12,45]],
    [["if",3,18],["add",14,42]],
    [["if",3,19],["add",14]],
    [["if",3,20],["add",14,42],["block",46]],
    [["if",3,18,21],["add",14,42]],
    [["if",3,22],["add",14,42]],
    [["if",3,23],["add",14,42]],
    [["if",3,24],["add",14,42]],
    [["if",3,25],["add",14,42]],
    [["if",3,26],["add",14]],
    [["if",3,27],["add",17,42,42]],
    [["if",28],["add",18]],
    [["if",3,29],["add",19,22,50]],
    [["if",3,30],["add",21,41]],
    [["if",3,31],["add",24]],
    [["if",3,32],["add",24]],
    [["if",3,33],["add",24]],
    [["if",3,34],["add",27]],
    [["if",37],["unless",35,36],["add",31]],
    [["if",38],["add",32]],
    [["if",3,39],["add",34],["block",46,54,59]],
    [["if",3,40],["unless",41],["add",34]],
    [["if",42,43],["add",34]],
    [["if",3,46],["add",0]],
    [["if",48,49],["add",35]],
    [["if",38,50],["add",36]],
    ...
    [["if",3,52],["add",42]],
    [["if",3,53],["add",42]],
    [["if",3,54],["add",42],["block",46]],
    [["if",3,55],["add",42]],
    [["if",3,56],["add",42]],
    [["if",3],["unless",57],["add",42]],
    [["if",3,58],["add",42]],
    [["if",3,59],["add",42]],
    [["if",3,60],["add",42]],
    [["if",3,61],["add",42]],
    [["if",3,62],["add",42]],
    [["if",0,2,3],["unless",1],["add",42]],
    [["if",3,63],["unless",64,65],["add",42]],
    [["if",3,66],["add",42]],
    [["if",5,67],["add",43]],
    [["if",0,3],["unless",1,44],["add",46,58]],
    [["if",5,6,72],["add",47,48]],
    [["if",0,3,72],["add",49]],
    [["if",73,74,75,76],["add",51]],
    [["if",14,77],["add",56]],
    [["if",74,76,78],["add",59]],
    [["if",3,44],["block",34,0]],
    [["if",3,45],["block",34]],
    [["if",3,47],["block",0]],
    [["if",3,68],["block",46,54,59]],
    [["if",3,69],["block",46,54,59]],
    [["if",3,70],["block",46,54,59]],
    [["if",3,71],["block",46]]]
},
"runtime":[
[],[]
...
" - "+Q+":"+W});E.apply(w.Ya,arguments)};w.write(y,function(){e(B,C);w.Ya.onerror=E;x.done();w=null;p()});return w}var q=0,r=[],w=null;return e(function(v,y,x){"function"===typeof x&&(x={done:x});x=g(x,k);v=/^#/.test(v)?l.document.getElementById(v.substr(1)):v.Tg?v[0]:v;var z=[v,y,x];v.$f={cancel:function(){z.stream?z.stream.abort():z[1]=a}};x.We(z);r.push(z);w||p();return v.$f},{streams:{},Xg:r,Ng:n})}();jc=l.postscribe}})();var yc={},zc=null,Ac=Math.random();yc.i="GTM-7BF3X";yc.sb="5t2";var Bc="www.googletagmanager.com/gtm.js";var Cc=Bc,Dc=null,Ec=null,Fc=null,Gc="//www.googletagmanager.com/a?id="+yc.i+"&cv=308",Hc={},Ic={},Jc=function(){var a=zc.sequence||0;zc.sequence=a+1;return a};var D=function(a,b,c,d){return(2===Kc()||d||"http:"!=f.location.protocol?a:b)+c},Kc=function(){var a=Oa(),b;if(1===a)a:{var c=Cc;c=c.toLowerCase();for(var d="https://"+c,e="http://"+c,g=1,h=u.getElementsByTagName("script"),k=0;k<h.length&&100>k;k++){var l=h[k].src;if(l){l=l.toLowerCase();if(0===l.indexOf(e)){b=3;break a}1===g&&0===l.indexOf(d)&&(g=2)}}b=g}else b=a;return b};var Lc=!1;
...
Y.a.e=["google"],function(){(function(a){Y.__e=a;Y.__e.g="e";Y.__e.h=!0;Y.__e.b=0})(function(a){return String(ud(a.vtp_gtmEventId,"event"))})}();Y.a.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=Nf(c,"gtm.click");Jh(d)}}(function(b){Y.__cl=b;Y.__cl.g="cl";Y.__cl.h=!0;Y.__cl.b=0})(function(b){if(!Qh("cl")){var c=K("document");Ra(c,"click",a,!0);Rh("cl")}A(b.vtp_gtmOnSuccess)})}();
...
Y.a.tg=["google"],function(){function a(k){h.push(k);1<h.length||A(function(){var l=h.join(",");h=[];Jh({event:"gtm.triggerGroup","gtm.triggers":l})})}function b(k,l){var m=d[l],n=m.indexOf(k);-1!==n&&(m.splice(n,1),m.length||a(l))}function c(k){A(k.vtp_gtmOnSuccess);var l=k.vtp_uniqueTriggerId,m=k.vtp_triggerIds,n=k.vtp_firingId;if(k.vtp_isListeningTag){var p=e[n];p?b(n,p):g.push(n)}else{d[l]=m;for(var t=0,q;q=m[t];t++)e[q]=l;for(var r=0;r<g.length;r++)b(g[r],l)}}var d={},e={},g=[],h=[];Y.__tg=c;Y.__tg.g="tg";Y.__tg.h=!0;Y.__tg.b=0}();
